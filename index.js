...
document.getElementById('caurosel-button-prev').addEventListener("click", moveToPreviousSlide)
document.getElementById('caurosel-button-next').addEventListener("click", moveToNextSlide)
